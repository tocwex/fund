...
++  build  ::  GET
  ...
  |^  ;div(id "maincontent", class "mx-auto lg:px-4")
        ;form(method "post", autocomplete "off")
          ...
          ;div
            ;div(class "flex justify-between")
              ...
              ;div(class "px-4 self-center")
                ;button(type "button", class "mile-button text-nowrap px-2 py-1 border-2 border-black bg-black text-white rounded-md hover:bg-gray-800 hover:border-gray-800 active:bg-white active:border-black active:text-black")
                  ; New Milestone +
                ==
              ==
            ==
                    ...
                    ;div
                      ;div(class "flex")
                        ...
                        ;div(class "m-1 p-1 w-full")
                          ...
                          ;input(id "mile-cost", type "number", name "m{<pin>}c", value "{(r-co:co (rlys cost.mil))}", class "m-1 p-1 border-2 border-gray-200 bg-gray-200 placeholder-gray-400 rounded-md w-full", placeholder "10000");
                        ==
                      ==
                      ;div(class "m-1 p-1")
                        ;div(class "m-1 pt-1 border-black font-light")
          ...
          ==
        ==
        ;+  ;script(type "module"): {skip}
      ==
  ++  skip
    ^~
    %-  trip
    '''
    document.querySelectorAll(".mile-button").forEach(mileButton => {
      mileButton.addEventListener("click", (event) => {
