...
:~  [%debug !>(%|)]
    ...
    [%meta-base !>('tocwexsyndicate.com')]  ::  TODO: Remove
    [%meta-site !>('https://tocwexsyndicate.com')]
    [%meta-help !>('https://docs.tocwexsyndicate.com')]
    [%meta-host !>('https://redhorizon.com/join/217ddb05-07f1-4897-8c6a-d6ef76da7380')]  ::  TODO: Remove (?)
    [%meta-tytl !>('%fund - sovereign work assessment tools for humans')]  ::  TODO: Remove (?)
