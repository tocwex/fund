...
++  build  ::  GET
  ...
  ^-  reply:rudder
  :-  %page
  %^  render:tw  q.byk.bowl  "Project 5 Assessor Review"
  :~  ;div(class "flex-grow")
            ...
            ;div(class "px-4")
              ...
              ;div(class "my-2 p-2 border-2 border-black flex items-center justify-between gap-x-2 rounded-md")
                ;div(class "flex flex-wrap sm:flex-nowrap sm:items-center gap-x-2")
                  ...
                  ==
                  ;div(class "p-1")
                    ; This is a message. It should be pretty short generally. what happens if the message is too long? this seems like a good max length?
                  ==
                ==
                ;div(class "flex flex-wrap sm:flex-nowrap items-center")
                  ;div(class "mx-auto p-1 font-semibold")
