...
++  build  ::  GET
  ...
  :~  ;nav(class "mx-4 mt-1.5 mb-2")
        ;ul(class "pb-2 pt-1 flex justify-between items-center border-black border-b-2")
          ...
          ==
          ;div(class "flex")
            ;div(class "hidden sm:block mx-2 p-1.5 border-2 border-white ease-in-out hover:italic active:underline active:italic duration-300")
              ;a(href "#")
                ; login with urbit
              ==
            ==
            ;button(class "mx-2 p-1.5 border-2 duration-300 border-black hover:rounded-lg hover:bg-yellow-400 hover:border-yellow-400 rounded-sm")
              ;a(href "#")
                ; connect wallet
              ==
            ==
